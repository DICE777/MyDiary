...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.ViewHolder> implements OnNoteItemClickListener {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView, final OnNoteItemClickListener listener, int layoutType) {
            ...
            weatherImage2 = itemView.findViewById(R.id.weatherImageView2);
        ...
        public void setWeatherImage(int weatherIndex) {
            switch (weatherIndex) {
                case 0:
                    weatherImage.setImageResource(R.drawable.weather_icon_1);
                    weatherImage2.setImageResource(R.drawable.weather_icon_1);
                    break;
                case 1:
                    weatherImage.setImageResource(R.drawable.weather_icon_2);
                    weatherImage2.setImageResource(R.drawable.weather_icon_2);
                    break;
                case 2:
                    weatherImage.setImageResource(R.drawable.weather_icon_3);
                    weatherImage2.setImageResource(R.drawable.weather_icon_3);
                    break;
                case 3:
                    weatherImage.setImageResource(R.drawable.weather_icon_4);
                    weatherImage2.setImageResource(R.drawable.weather_icon_4);
                    break;
                case 4:
                    weatherImage.setImageResource(R.drawable.weather_icon_5);
                    weatherImage2.setImageResource(R.drawable.weather_icon_5);
                    break;
                case 5:
                    weatherImage.setImageResource(R.drawable.weather_icon_6);
                    weatherImage2.setImageResource(R.drawable.weather_icon_6);
                    break;
                case 6:
                    weatherImage.setImageResource(R.drawable.weather_icon_7);
                    weatherImage2.setImageResource(R.drawable.weather_icon_7);
                    break;
                default:
                    weatherImage.setImageResource(R.drawable.weather_icon_1);
                    weatherImage2.setImageResource(R.drawable.weather_icon_1);
