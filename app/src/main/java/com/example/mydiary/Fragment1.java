...
public class Fragment1 extends Fragment {
    ...
    public static final String TAG = Fragment1.class.getCanonicalName();
    ...
    private void initUI(ViewGroup rootView) {
        ...
        adapter.addItem(new Note(1, "1", "강남구 삼성동", "", "", "친구와 재밌게 놀았어!", "0", "capture1.jpg", "2월 11일"));
        adapter.addItem(new Note(2, "0", "강남구 역삼동", "", "", "집에 왔는데 너무 피곤해ㅠㅠ", "0", "null", "2월 13일"));
    ...
    public int loadNoteListData() {
        ...
        if (database != null) {
            ...
            NoteDatabase.println("record count : " + recordCount + "\n");
            ...
            for (int i = 0; i < recordCount; i++) {
                ...
                NoteDatabase.println("#" + i + " -> " + _id + ", " + weather + ", " +
